...
<%
	...
	if(request.getParameter("lectuerDivide") != null) {
		lectuerDivide = (String) request.getParameter("lectuerDivide");
	}
	...
	if(lectureName == null || professorName == null || lectureYear == 0 || semesterDivide == null || lectuerDivide == null ||
	...
	int result = evaluationDAO.write(new EvaluationDTO(0, userID, lectureName, professorName,
			lectureYear, semesterDivide, lectuerDivide, evaluationTitle, evaluationContent, totalScore, creditScore, comfortableScore,
			lectureScore, 0));
	if (result == -1) {
		PrintWriter script = response.getWriter();
		script.println("<script>");
