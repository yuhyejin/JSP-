...
public class EvaluationDTO {
	...
	public void setEvaluation(int evaluationID) {
	...
	public String getLectuerDivide() {
		return lectuerDivide;
	}
	public void setLectuerDivide(String lectuerDivide) {
		this.lectuerDivide = lectuerDivide;
	}
	...
	public EvaluationDTO(int evaluationID, String userID, String lectureName, String professorName, int lectureYear,
			String semesterDivide, String lectuerDivide, String evaluationTitle, String evaluationContent,
